...
namespace TheSongOfTheWheels
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int controllNumber = int.Parse(Console.ReadLine());
            int counter = 0;
            string password = "";
            ...
            //1•	Ако са намерени четворки числа (аbcd), отговарящи на условието, ги отпечатваме всичките с разделител интервал: “{а}{b}{c}{d} ”
            //2•	Отпечатва се един от двата реда на нов ред:
