...
namespace DirectoryTraversal
{
    class Program
    {
        ...
        {
            string directory = @"C:\Users\NUT82\Downloads";
            string desctopDirectory = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
            ...
            File.WriteAllText(Path.Combine(desctopDirectory, "report.txt"), output.ToString());
